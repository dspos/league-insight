...
**输出文件**: `league-insight-backend/target/league-insight-native.exe`
...
```bash
# 直接运行（无需 JVM）
.\league-insight-backend\target\league-insight-native.exe
...
```bash
# 启用详细日志
.\league-insight-native.exe --debug

# 查看 GraalVM 版本信息
.\league-insight-native.exe --version
```
